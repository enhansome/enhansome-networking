...
An [awesome list](https://github.com/sindresorhus/awesome) ⭐ 495,060 | 🐛 100 | 📅 2026-06-30 of resources to design, implement and operate computer networks.
...
* [Firezone](https://github.com/firezone/firezone) ⭐ 9,013 | 🐛 382 | 🌐 Elixir | 📅 2026-08-13 - Open-source VPN server and egress firewall for Linux built on WireGuard. Firezone is easy to set up (all dependencies are bundled thanks to Chef Omnibus), secure, performant, and self hostable.
* [Pilot Protocol](https://github.com/TeoSlayer/pilotprotocol) ⭐ 131 | 🐛 5 | 🌐 Go | 📅 2026-08-10 - Overlay network stack for AI agents with virtual addresses, encrypted UDP tunnels (AES-256-GCM), NAT traversal, and mutual trust. Written in Go with zero dependencies.
...
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,444 | 🐛 37 | 🌐 C | 📅 2026-08-12 - Arkime augments your current security infrastructure to store and index network traffic in standard PCAP format, providing fast, indexed access.
* [snabb](https://github.com/snabbco/snabb) ⭐ 3,034 | 🐛 15 | 🌐 Lua | 📅 2026-07-30 - Snabb (formerly "Snabb Switch") is a simple and fast packet networking toolkit.
...
* [Oxidized](https://github.com/ytti/oxidized) ⭐ 3,492 | 🐛 71 | 🌐 Ruby | 📅 2026-08-07 - Network device configuration backup tool. It's a [RANCID](https://www.shrubbery.net/rancid/) replacement.
* [Batfish](https://github.com/batfish/batfish) ⭐ 1,449 | 🐛 280 | 🌐 Java | 📅 2026-08-11 - Network configuration analysis tool that can find bugs and guarantee the correctness of (planned or current) network configurations.
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,343 | 🐛 838 | 🌐 Python | 📅 2026-08-11 - IT automation platform that makes your applications and systems easier to deploy by using SSH, with no agents to install on remote systems.
* [AWX](https://github.com/ansible/awx) ⭐ 15,525 | 🐛 1,863 | 🌐 Python | 📅 2026-08-12 - the upstream project for Tower / AAP2, a commercial derivative of AWX.
...
* [nornir](https://github.com/nornir-automation/nornir) ⭐ 1,611 | 🐛 48 | 🌐 Python | 📅 2026-08-12 - Pluggable multi-threaded framework with inventory management to help operate collections of devices.
* [ntc-templates](https://github.com/networktocode/ntc-templates) ⭐ 1,285 | 🐛 33 | 🌐 Python | 📅 2026-07-27 - TextFSM templates for parsing show commands of network devices.
* [TextFSM](https://github.com/google/textfsm) ⭐ 1,245 | 🐛 16 | 🌐 Python | 📅 2025-04-17 -  Python module for parsing semi-structured text into Python tables.
...
* [CNaaS-NMS](https://github.com/SUNET/cnaas-nms) ⭐ 90 | 🐛 38 | 🌐 Python | 📅 2026-08-12 - Campus Network-as-a-Service - Network Management System. Software to automate management of a campus network (LAN).
...
* [DefenseClaw](https://github.com/cisco-ai-defense/defenseclaw) ⭐ 818 | 🐛 40 | 🌐 Go | 📅 2026-08-12 - DefenseClaw is the enterprise governance layer for OpenClaw
* [NetClaw](https://github.com/automateyournetwork/netclaw) ⭐ 632 | 🐛 1 | 🌐 Python | 📅 2026-08-12 - A CCIE-level AI network engineering coworker, built on OpenClaw
...
* [Malcolm](https://github.com/idaholab/Malcolm) ⭐ 477 | 🐛 4 | 🌐 Python | 📅 2026-08-09 - Malcolm is a powerful, easily deployable network traffic analysis tool suite for full packet capture artifacts (PCAP files) and Zeek logs.
...
* [netbox](https://github.com/digitalocean/netbox) ⭐ 21,304 | 🐛 212 | 🌐 Python | 📅 2026-08-12 - IP address management (IPAM) and data center infrastructure management (DCIM) tool.
* [nautobot](https://github.com/nautobot/nautobot) ⭐ 1,576 | 🐛 1,002 | 🌐 Python | 📅 2026-08-12 - Network Source of Truth & Network Automation Platform.
...
* [infrahub](https://github.com/opsmill/infrahub) ⭐ 501 | 🐛 487 | 🌐 Python | 📅 2026-08-13 -  Infrahub is a graph-based data management platform with built-in version control, CI workflows, peer review, and API access. It’s purpose-built to power reliable infrastructure automation at scale.
* [nsot](https://github.com/dropbox/nsot) ⭐ 406 | 🐛 64 | 🌐 Python | 📅 2024-02-13 - Network Source of Truth is an open source IPAM and network inventory database.
...
* [containerlab](https://github.com/srl-labs/containerlab) ⭐ 2,733 | 🐛 66 | 🌐 Go | 📅 2026-08-13 - Container-based networking labs, though support has been added to integrate Virtual Machines (VMs).
* [netlab](https://github.com/ipspace/netlab) ⭐ 722 | 🐛 34 | 🌐 Python | 📅 2026-08-12 - netlab is bringing infrastructure-as-code concepts to networking labs. You'll describe your high-level network topology and routing design in a YAML file, and the tools in this repository auto-define details.
* [CML](https://www.cisco.com/site/us/en/learn/training-certifications/training/modeling-labs/index.html) - Cisco Modeling Labs is a network simulation tool with both free and paid versions. CML is the successor to VIRL. Community contributed content and resources are available via [cml-community](https://github.com/CiscoDevNet/cml-community) ⭐ 629 | 🐛 4 | 🌐 Shell | 📅 2026-08-06.
* [PNETLab](https://github.com/pnetlab/pnetlab_main) ⭐ 79 | 🐛 3 | 🌐 JavaScript | 📅 2023-07-24 - Introducing the most powerful tool to create, share and practice Networking Lab with multi-vendors.
...
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 10,932 | 🐛 41 | 🌐 Shell | 📅 2026-07-01 - a Docker + Kubernetes network trouble-shooting swiss-army container.
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 10,932 | 🐛 41 | 🌐 Shell | 📅 2026-07-01 - a Docker + Kubernetes network trouble-shooting swiss-army container.
...
* [netdata](https://github.com/firehol/netdata) ⭐ 80,154 | 🐛 382 | 🌐 Go | 📅 2026-08-13 - Distributed real-time performance and health monitoring.
...
* ELK Stack
  * [Elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,842 | 🐛 5,990 | 🌐 Java | 📅 2026-08-13 - Open Source, Distributed, RESTful Search Engine.
  * [Kibana](https://github.com/elastic/kibana) ⭐ 21,235 | 🐛 14,502 | 🌐 TypeScript | 📅 2026-08-13 - Analytics and search dashboard for Elasticsearch.
  * [LogStash](https://github.com/elastic/logstash) ⭐ 14,916 | 🐛 2,250 | 🌐 Java | 📅 2026-08-12 - Transport and process your logs, events, or other data.
