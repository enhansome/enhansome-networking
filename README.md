...
An [awesome list](https://github.com/sindresorhus/awesome) ⭐ 509,570 | 🐛 106 | 📅 2026-09-02 of resources to design, implement and operate computer networks.
...
* [snabb](https://github.com/snabbco/snabb) ⭐ 3,032 | 🐛 16 | 🌐 Lua | 📅 2026-07-30 - Snabb (formerly "Snabb Switch") is a simple and fast packet networking toolkit.

## VPN

* [Firezone](https://github.com/firezone/firezone) ⭐ 9,103 | 🐛 395 | 🌐 Elixir | 📅 2026-09-24 - Open-source VPN server and egress firewall for Linux built on WireGuard. Firezone is easy to set up (all dependencies are bundled thanks to Chef Omnibus), secure, performant, and self hostable.
* [Pilot Protocol](https://github.com/TeoSlayer/pilotprotocol) ⭐ 139 | 🐛 6 | 🌐 Go | 📅 2026-09-24 - Overlay network stack for AI agents with virtual addresses, encrypted UDP tunnels (AES-256-GCM), NAT traversal, and mutual trust. Written in Go with zero dependencies.
...
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,475 | 🐛 38 | 🌐 C | 📅 2026-09-23 - Arkime augments your current security infrastructure to store and index network traffic in standard PCAP format, providing fast, indexed access.
* [snabb](https://github.com/snabbco/snabb) ⭐ 3,032 | 🐛 16 | 🌐 Lua | 📅 2026-07-30 - Snabb (formerly "Snabb Switch") is a simple and fast packet networking toolkit.
...
* [Oxidized](https://github.com/ytti/oxidized) ⭐ 3,589 | 🐛 63 | 🌐 Ruby | 📅 2026-09-23 - Network device configuration backup tool. It's a [RANCID](https://www.shrubbery.net/rancid/) replacement.
* [Batfish](https://github.com/batfish/batfish) ⭐ 1,484 | 🐛 280 | 🌐 Java | 📅 2026-09-24 - Network configuration analysis tool that can find bugs and guarantee the correctness of (planned or current) network configurations.
...
* [fetchconfig](https://github.com/udhos/fetchconfig) ⭐ 15 | 🐛 3 | 🌐 Perl | 📅 2017-02-01 - fetchconfig is a Perl script for retrieving configuration of
  multiple devices.
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,784 | 🐛 842 | 🌐 Python | 📅 2026-09-24 - IT automation platform that makes your applications and systems easier to deploy by using SSH, with no agents to install on remote systems.
* [AWX](https://github.com/ansible/awx) ⭐ 15,568 | 🐛 1,873 | 🌐 Python | 📅 2026-09-24 - the upstream project for Tower / AAP2, a commercial derivative of AWX.
* [netmiko](https://github.com/ktbyers/netmiko) ⭐ 4,292 | 🐛 63 | 🌐 Python | 📅 2026-09-21 - Multi-vendor library to simplify Paramiko SSH connections to network devices.
* [nornir](https://github.com/nornir-automation/nornir) ⭐ 1,625 | 🐛 45 | 🌐 Python | 📅 2026-09-23 - Pluggable multi-threaded framework with inventory management to help operate collections of devices.
* [ntc-templates](https://github.com/networktocode/ntc-templates) ⭐ 1,298 | 🐛 44 | 🌐 Python | 📅 2026-09-16 - TextFSM templates for parsing show commands of network devices.
...
* [CNaaS-NMS](https://github.com/SUNET/cnaas-nms) ⭐ 93 | 🐛 35 | 🌐 Python | 📅 2026-09-22 - Campus Network-as-a-Service - Network Management System. Software to automate management of a campus network (LAN).
...
* [DefenseClaw](https://github.com/cisco-ai-defense/defenseclaw) ⭐ 849 | 🐛 28 | 🌐 Go | 📅 2026-09-24 - DefenseClaw is the enterprise governance layer for OpenClaw
* [NetClaw](https://github.com/automateyournetwork/netclaw) ⭐ 665 | 🐛 1 | 🌐 Python | 📅 2026-09-20 - A CCIE-level AI network engineering coworker, built on OpenClaw
...
* [vFlow](https://github.com/EdgeCast/vflow) ⭐ 1,156 | 🐛 71 | 🌐 Go | 📅 2024-08-22 - High-performance, scalable and reliable IPFIX, sFlow and Netflow collector (written in pure Golang).
* [BGPAlerter](https://github.com/nttgin/BGPalerter) ⭐ 1,016 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-22 - Self-configuring BGP monitoring tool
...
* [Malcolm](https://github.com/idaholab/Malcolm) ⭐ 485 | 🐛 0 | 🌐 Python | 📅 2026-09-23 - Malcolm is a powerful, easily deployable network traffic analysis tool suite for full packet capture artifacts (PCAP files) and Zeek logs.
...
* [netbox](https://github.com/digitalocean/netbox) ⭐ 21,593 | 🐛 224 | 🌐 Python | 📅 2026-09-24 - IP address management (IPAM) and data center infrastructure management (DCIM) tool.
* [nautobot](https://github.com/nautobot/nautobot) ⭐ 1,612 | 🐛 1,031 | 🌐 Python | 📅 2026-09-23 - Network Source of Truth & Network Automation Platform.
...
* [infrahub](https://github.com/opsmill/infrahub) ⭐ 526 | 🐛 564 | 🌐 Python | 📅 2026-09-24 -  Infrahub is a graph-based data management platform with built-in version control, CI workflows, peer review, and API access. It’s purpose-built to power reliable infrastructure automation at scale.
...
* [containerlab](https://github.com/srl-labs/containerlab) ⭐ 2,834 | 🐛 67 | 🌐 Go | 📅 2026-09-22 - Container-based networking labs, though support has been added to integrate Virtual Machines (VMs).
* [netlab](https://github.com/ipspace/netlab) ⭐ 744 | 🐛 25 | 🌐 Python | 📅 2026-09-23 - netlab is bringing infrastructure-as-code concepts to networking labs. You'll describe your high-level network topology and routing design in a YAML file, and the tools in this repository auto-define details.
* [CML](https://www.cisco.com/site/us/en/learn/training-certifications/training/modeling-labs/index.html) - Cisco Modeling Labs is a network simulation tool with both free and paid versions. CML is the successor to VIRL. Community contributed content and resources are available via [cml-community](https://github.com/CiscoDevNet/cml-community) ⭐ 653 | 🐛 5 | 🌐 Shell | 📅 2026-08-28.
...
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 11,009 | 🐛 44 | 🌐 Shell | 📅 2026-09-22 - a Docker + Kubernetes network trouble-shooting swiss-army container.
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 11,009 | 🐛 44 | 🌐 Shell | 📅 2026-09-22 - a Docker + Kubernetes network trouble-shooting swiss-army container.
...
* [netdata](https://github.com/firehol/netdata) ⭐ 80,637 | 🐛 411 | 🌐 Go | 📅 2026-09-24 - Distributed real-time performance and health monitoring.
...
* ELK Stack
  * [Elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,970 | 🐛 6,089 | 🌐 Java | 📅 2026-09-24 - Open Source, Distributed, RESTful Search Engine.
  * [Kibana](https://github.com/elastic/kibana) ⭐ 21,299 | 🐛 14,590 | 🌐 TypeScript | 📅 2026-09-24 - Analytics and search dashboard for Elasticsearch.
  * [LogStash](https://github.com/elastic/logstash) ⭐ 14,949 | 🐛 2,255 | 🌐 Java | 📅 2026-09-23 - Transport and process your logs, events, or other data.
