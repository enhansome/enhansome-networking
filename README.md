...
An [awesome list](https://github.com/sindresorhus/awesome) ⭐ 500,725 | 🐛 105 | 📅 2026-08-21 of resources to design, implement and operate computer networks.
...
* [Firezone](https://github.com/firezone/firezone) ⭐ 9,043 | 🐛 402 | 🌐 Elixir | 📅 2026-08-28 - Open-source VPN server and egress firewall for Linux built on WireGuard. Firezone is easy to set up (all dependencies are bundled thanks to Chef Omnibus), secure, performant, and self hostable.
* [Pilot Protocol](https://github.com/TeoSlayer/pilotprotocol) ⭐ 133 | 🐛 7 | 🌐 Go | 📅 2026-08-28 - Overlay network stack for AI agents with virtual addresses, encrypted UDP tunnels (AES-256-GCM), NAT traversal, and mutual trust. Written in Go with zero dependencies.
...
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,459 | 🐛 35 | 🌐 C | 📅 2026-08-27 - Arkime augments your current security infrastructure to store and index network traffic in standard PCAP format, providing fast, indexed access.
* [snabb](https://github.com/snabbco/snabb) ⭐ 3,032 | 🐛 15 | 🌐 Lua | 📅 2026-07-30 - Snabb (formerly "Snabb Switch") is a simple and fast packet networking toolkit.
...
* [Oxidized](https://github.com/ytti/oxidized) ⭐ 3,533 | 🐛 65 | 🌐 Ruby | 📅 2026-08-27 - Network device configuration backup tool. It's a [RANCID](https://www.shrubbery.net/rancid/) replacement.
* [Batfish](https://github.com/batfish/batfish) ⭐ 1,460 | 🐛 278 | 🌐 Java | 📅 2026-08-27 - Network configuration analysis tool that can find bugs and guarantee the correctness of (planned or current) network configurations.
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,487 | 🐛 833 | 🌐 Python | 📅 2026-08-27 - IT automation platform that makes your applications and systems easier to deploy by using SSH, with no agents to install on remote systems.
* [AWX](https://github.com/ansible/awx) ⭐ 15,537 | 🐛 1,861 | 🌐 Python | 📅 2026-08-28 - the upstream project for Tower / AAP2, a commercial derivative of AWX.
...
* [nornir](https://github.com/nornir-automation/nornir) ⭐ 1,614 | 🐛 55 | 🌐 Python | 📅 2026-08-28 - Pluggable multi-threaded framework with inventory management to help operate collections of devices.
* [ntc-templates](https://github.com/networktocode/ntc-templates) ⭐ 1,291 | 🐛 41 | 🌐 Python | 📅 2026-08-24 - TextFSM templates for parsing show commands of network devices.
...
* [DefenseClaw](https://github.com/cisco-ai-defense/defenseclaw) ⭐ 829 | 🐛 44 | 🌐 Go | 📅 2026-08-28 - DefenseClaw is the enterprise governance layer for OpenClaw
* [NetClaw](https://github.com/automateyournetwork/netclaw) ⭐ 645 | 🐛 1 | 🌐 Python | 📅 2026-08-24 - A CCIE-level AI network engineering coworker, built on OpenClaw
...
* [BGPAlerter](https://github.com/nttgin/BGPalerter) ⭐ 1,011 | 🐛 10 | 🌐 JavaScript | 📅 2026-07-28 - Self-configuring BGP monitoring tool
...
* [netbox](https://github.com/digitalocean/netbox) ⭐ 21,405 | 🐛 200 | 🌐 Python | 📅 2026-08-28 - IP address management (IPAM) and data center infrastructure management (DCIM) tool.
* [nautobot](https://github.com/nautobot/nautobot) ⭐ 1,587 | 🐛 1,003 | 🌐 Python | 📅 2026-08-28 - Network Source of Truth & Network Automation Platform.
...
* [infrahub](https://github.com/opsmill/infrahub) ⭐ 508 | 🐛 494 | 🌐 Python | 📅 2026-08-28 -  Infrahub is a graph-based data management platform with built-in version control, CI workflows, peer review, and API access. It’s purpose-built to power reliable infrastructure automation at scale.
...
* [containerlab](https://github.com/srl-labs/containerlab) ⭐ 2,779 | 🐛 48 | 🌐 Go | 📅 2026-08-28 - Container-based networking labs, though support has been added to integrate Virtual Machines (VMs).
* [netlab](https://github.com/ipspace/netlab) ⭐ 731 | 🐛 27 | 🌐 Python | 📅 2026-08-27 - netlab is bringing infrastructure-as-code concepts to networking labs. You'll describe your high-level network topology and routing design in a YAML file, and the tools in this repository auto-define details.
* [CML](https://www.cisco.com/site/us/en/learn/training-certifications/training/modeling-labs/index.html) - Cisco Modeling Labs is a network simulation tool with both free and paid versions. CML is the successor to VIRL. Community contributed content and resources are available via [cml-community](https://github.com/CiscoDevNet/cml-community) ⭐ 639 | 🐛 5 | 🌐 Shell | 📅 2026-08-06.
...
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 10,961 | 🐛 43 | 🌐 Shell | 📅 2026-07-01 - a Docker + Kubernetes network trouble-shooting swiss-army container.
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 10,961 | 🐛 43 | 🌐 Shell | 📅 2026-07-01 - a Docker + Kubernetes network trouble-shooting swiss-army container.
...
* [netdata](https://github.com/firehol/netdata) ⭐ 80,331 | 🐛 383 | 🌐 Go | 📅 2026-08-28 - Distributed real-time performance and health monitoring.
...
* ELK Stack
  * [Elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,873 | 🐛 5,948 | 🌐 Java | 📅 2026-08-28 - Open Source, Distributed, RESTful Search Engine.
  * [Kibana](https://github.com/elastic/kibana) ⭐ 21,266 | 🐛 14,255 | 🌐 TypeScript | 📅 2026-08-28 - Analytics and search dashboard for Elasticsearch.
