...
An [awesome list](https://github.com/sindresorhus/awesome) ⭐ 506,482 | 🐛 106 | 📅 2026-09-02 of resources to design, implement and operate computer networks.
...
* [snabb](https://github.com/snabbco/snabb) ⭐ 3,031 | 🐛 15 | 🌐 Lua | 📅 2026-07-30 - Snabb (formerly "Snabb Switch") is a simple and fast packet networking toolkit.

## VPN

* [Firezone](https://github.com/firezone/firezone) ⭐ 9,095 | 🐛 415 | 🌐 Elixir | 📅 2026-09-16 - Open-source VPN server and egress firewall for Linux built on WireGuard. Firezone is easy to set up (all dependencies are bundled thanks to Chef Omnibus), secure, performant, and self hostable.
* [Pilot Protocol](https://github.com/TeoSlayer/pilotprotocol) ⭐ 138 | 🐛 4 | 🌐 Go | 📅 2026-09-13 - Overlay network stack for AI agents with virtual addresses, encrypted UDP tunnels (AES-256-GCM), NAT traversal, and mutual trust. Written in Go with zero dependencies.
...
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,467 | 🐛 37 | 🌐 C | 📅 2026-09-14 - Arkime augments your current security infrastructure to store and index network traffic in standard PCAP format, providing fast, indexed access.
* [snabb](https://github.com/snabbco/snabb) ⭐ 3,031 | 🐛 15 | 🌐 Lua | 📅 2026-07-30 - Snabb (formerly "Snabb Switch") is a simple and fast packet networking toolkit.
...
* [Oxidized](https://github.com/ytti/oxidized) ⭐ 3,575 | 🐛 65 | 🌐 Ruby | 📅 2026-09-14 - Network device configuration backup tool. It's a [RANCID](https://www.shrubbery.net/rancid/) replacement.
* [Batfish](https://github.com/batfish/batfish) ⭐ 1,473 | 🐛 279 | 🌐 Java | 📅 2026-09-16 - Network configuration analysis tool that can find bugs and guarantee the correctness of (planned or current) network configurations.
...
* [fetchconfig](https://github.com/udhos/fetchconfig) ⭐ 15 | 🐛 2 | 🌐 Perl | 📅 2017-02-01 - fetchconfig is a Perl script for retrieving configuration of
  multiple devices.
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,694 | 🐛 831 | 🌐 Python | 📅 2026-09-15 - IT automation platform that makes your applications and systems easier to deploy by using SSH, with no agents to install on remote systems.
* [AWX](https://github.com/ansible/awx) ⭐ 15,556 | 🐛 1,871 | 🌐 Python | 📅 2026-09-15 - the upstream project for Tower / AAP2, a commercial derivative of AWX.
* [netmiko](https://github.com/ktbyers/netmiko) ⭐ 4,285 | 🐛 63 | 🌐 Python | 📅 2026-08-18 - Multi-vendor library to simplify Paramiko SSH connections to network devices.
* [nornir](https://github.com/nornir-automation/nornir) ⭐ 1,623 | 🐛 44 | 🌐 Python | 📅 2026-09-06 - Pluggable multi-threaded framework with inventory management to help operate collections of devices.
* [ntc-templates](https://github.com/networktocode/ntc-templates) ⭐ 1,296 | 🐛 44 | 🌐 Python | 📅 2026-09-15 - TextFSM templates for parsing show commands of network devices.
...
* [trigger](https://github.com/trigger/trigger) ⭐ 559 | 🐛 65 | 🌐 Python | 📅 2026-09-09 - Robust network automation toolkit written in Python that was designed for interfacing with network devices.
* [TTP](https://github.com/dmulyalin/ttp) ⭐ 391 | 🐛 44 | 🌐 Python | 📅 2026-03-24 - TTP is a Python library for semi-structured text parsing using templates.
* [CNaaS-NMS](https://github.com/SUNET/cnaas-nms) ⭐ 90 | 🐛 31 | 🌐 Python | 📅 2026-09-15 - Campus Network-as-a-Service - Network Management System. Software to automate management of a campus network (LAN).
...
* [GitNOps](https://github.com/mcgonagle/GitNops) ⭐ 27 | 🐛 1 | 🌐 HCL | 📅 2026-09-15 - GitNops is an operational framework that takes DevOps best practices used for application development such as version control, collaboration, compliance, and CI/CD, and applies them to network automation.
...
* [DefenseClaw](https://github.com/cisco-ai-defense/defenseclaw) ⭐ 843 | 🐛 24 | 🌐 Go | 📅 2026-09-16 - DefenseClaw is the enterprise governance layer for OpenClaw
* [NetClaw](https://github.com/automateyournetwork/netclaw) ⭐ 661 | 🐛 1 | 🌐 Python | 📅 2026-09-06 - A CCIE-level AI network engineering coworker, built on OpenClaw
...
* [BGPAlerter](https://github.com/nttgin/BGPalerter) ⭐ 1,013 | 🐛 8 | 🌐 JavaScript | 📅 2026-07-28 - Self-configuring BGP monitoring tool
* [goFlow](https://github.com/cloudflare/goflow) ⚠️ Archived - a NetFlow/IPFIX/sFlow collector in Go.
* [Vaping](https://github.com/20c/vaping) ⭐ 542 | 🐛 48 | 🌐 Python | 📅 2024-12-20 - vaping is a healthy alternative to smokeping.
...
* [OSPF Watcher](https://github.com/Vadims06/ospfwatcher) ⭐ 86 | 🐛 8 | 🌐 Python | 📅 2026-08-19 - Monitors OSPF topology changes and LSA updates in real time. Provides event visualization and historical tracking via Topolograph or centralized logging through ELK.
* [UDPing](https://github.com/yahoo/UDPing) ⭐ 85 | 🐛 4 | 🌐 C++ | 📅 2026-08-12 - Measure latency and packet loss across a link.
* [rkik](https://github.com/aguacero7/rkik) ⭐ 59 | 🐛 3 | 🌐 Rust | 📅 2026-09-14 - Light, easy-to-use monitoring tool for NTP servers
* [IS-IS Watcher](https://github.com/Vadims06/isiswatcher) ⭐ 13 | 🐛 1 | 🌐 Python | 📅 2026-08-19 - Monitors IS-IS topology changes and PDU updates in real time. Provides event visualization and historical tracking via Topolograph or centralized logging through ELK.
...
* [Malcolm](https://github.com/idaholab/Malcolm) ⭐ 481 | 🐛 2 | 🌐 Python | 📅 2026-08-25 - Malcolm is a powerful, easily deployable network traffic analysis tool suite for full packet capture artifacts (PCAP files) and Zeek logs.
...
* [netbox](https://github.com/digitalocean/netbox) ⭐ 21,537 | 🐛 208 | 🌐 Python | 📅 2026-09-16 - IP address management (IPAM) and data center infrastructure management (DCIM) tool.
* [nautobot](https://github.com/nautobot/nautobot) ⭐ 1,607 | 🐛 1,028 | 🌐 Python | 📅 2026-09-15 - Network Source of Truth & Network Automation Platform.
* [drawthe.net](https://github.com/cidrblock/drawthe.net) ⭐ 1,181 | 🐛 18 | 🌐 JavaScript | 📅 2024-03-19 - Draws network diagrams dynamically from a text file describing the placement, layout and icons.
* [infrahub](https://github.com/opsmill/infrahub) ⭐ 518 | 🐛 549 | 🌐 Python | 📅 2026-09-15 -  Infrahub is a graph-based data management platform with built-in version control, CI workflows, peer review, and API access. It’s purpose-built to power reliable infrastructure automation at scale.
...
* [containerlab](https://github.com/srl-labs/containerlab) ⭐ 2,818 | 🐛 65 | 🌐 Go | 📅 2026-09-15 - Container-based networking labs, though support has been added to integrate Virtual Machines (VMs).
* [netlab](https://github.com/ipspace/netlab) ⭐ 739 | 🐛 24 | 🌐 Python | 📅 2026-09-15 - netlab is bringing infrastructure-as-code concepts to networking labs. You'll describe your high-level network topology and routing design in a YAML file, and the tools in this repository auto-define details.
* [CML](https://www.cisco.com/site/us/en/learn/training-certifications/training/modeling-labs/index.html) - Cisco Modeling Labs is a network simulation tool with both free and paid versions. CML is the successor to VIRL. Community contributed content and resources are available via [cml-community](https://github.com/CiscoDevNet/cml-community) ⭐ 648 | 🐛 5 | 🌐 Shell | 📅 2026-08-28.
...
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 10,998 | 🐛 43 | 🌐 Shell | 📅 2026-07-01 - a Docker + Kubernetes network trouble-shooting swiss-army container.
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 10,998 | 🐛 43 | 🌐 Shell | 📅 2026-07-01 - a Docker + Kubernetes network trouble-shooting swiss-army container.
...
* [netdata](https://github.com/firehol/netdata) ⭐ 80,540 | 🐛 406 | 🌐 Go | 📅 2026-09-16 - Distributed real-time performance and health monitoring.
...
* ELK Stack
  * [Elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,919 | 🐛 6,068 | 🌐 Java | 📅 2026-09-16 - Open Source, Distributed, RESTful Search Engine.
  * [Kibana](https://github.com/elastic/kibana) ⭐ 21,288 | 🐛 14,677 | 🌐 TypeScript | 📅 2026-09-16 - Analytics and search dashboard for Elasticsearch.
  * [LogStash](https://github.com/elastic/logstash) ⭐ 14,941 | 🐛 2,259 | 🌐 Java | 📅 2026-09-15 - Transport and process your logs, events, or other data.
