...
An [awesome list](https://github.com/sindresorhus/awesome) ⭐ 500,365 | 🐛 105 | 📅 2026-08-21 of resources to design, implement and operate computer networks.
...
* [Firezone](https://github.com/firezone/firezone) ⭐ 9,043 | 🐛 396 | 🌐 Elixir | 📅 2026-08-27 - Open-source VPN server and egress firewall for Linux built on WireGuard. Firezone is easy to set up (all dependencies are bundled thanks to Chef Omnibus), secure, performant, and self hostable.
* [Pilot Protocol](https://github.com/TeoSlayer/pilotprotocol) ⭐ 133 | 🐛 6 | 🌐 Go | 📅 2026-08-26 - Overlay network stack for AI agents with virtual addresses, encrypted UDP tunnels (AES-256-GCM), NAT traversal, and mutual trust. Written in Go with zero dependencies.
...
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,459 | 🐛 37 | 🌐 C | 📅 2026-08-26 - Arkime augments your current security infrastructure to store and index network traffic in standard PCAP format, providing fast, indexed access.
* [snabb](https://github.com/snabbco/snabb) ⭐ 3,032 | 🐛 15 | 🌐 Lua | 📅 2026-07-30 - Snabb (formerly "Snabb Switch") is a simple and fast packet networking toolkit.
...
* [Oxidized](https://github.com/ytti/oxidized) ⭐ 3,529 | 🐛 63 | 🌐 Ruby | 📅 2026-08-24 - Network device configuration backup tool. It's a [RANCID](https://www.shrubbery.net/rancid/) replacement.
* [Batfish](https://github.com/batfish/batfish) ⭐ 1,460 | 🐛 281 | 🌐 Java | 📅 2026-08-27 - Network configuration analysis tool that can find bugs and guarantee the correctness of (planned or current) network configurations.
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,479 | 🐛 834 | 🌐 Python | 📅 2026-08-26 - IT automation platform that makes your applications and systems easier to deploy by using SSH, with no agents to install on remote systems.
* [AWX](https://github.com/ansible/awx) ⭐ 15,537 | 🐛 1,862 | 🌐 Python | 📅 2026-08-27 - the upstream project for Tower / AAP2, a commercial derivative of AWX.
...
* [nornir](https://github.com/nornir-automation/nornir) ⭐ 1,613 | 🐛 49 | 🌐 Python | 📅 2026-08-26 - Pluggable multi-threaded framework with inventory management to help operate collections of devices.
...
* [CNaaS-NMS](https://github.com/SUNET/cnaas-nms) ⭐ 90 | 🐛 33 | 🌐 Python | 📅 2026-08-27 - Campus Network-as-a-Service - Network Management System. Software to automate management of a campus network (LAN).
...
* [DefenseClaw](https://github.com/cisco-ai-defense/defenseclaw) ⭐ 826 | 🐛 44 | 🌐 Go | 📅 2026-08-27 - DefenseClaw is the enterprise governance layer for OpenClaw
* [NetClaw](https://github.com/automateyournetwork/netclaw) ⭐ 644 | 🐛 0 | 🌐 Python | 📅 2026-08-24 - A CCIE-level AI network engineering coworker, built on OpenClaw
...
* [netbox](https://github.com/digitalocean/netbox) ⭐ 21,399 | 🐛 215 | 🌐 Python | 📅 2026-08-26 - IP address management (IPAM) and data center infrastructure management (DCIM) tool.
* [nautobot](https://github.com/nautobot/nautobot) ⭐ 1,586 | 🐛 1,000 | 🌐 Python | 📅 2026-08-26 - Network Source of Truth & Network Automation Platform.
...
* [infrahub](https://github.com/opsmill/infrahub) ⭐ 507 | 🐛 492 | 🌐 Python | 📅 2026-08-27 -  Infrahub is a graph-based data management platform with built-in version control, CI workflows, peer review, and API access. It’s purpose-built to power reliable infrastructure automation at scale.
...
* [containerlab](https://github.com/srl-labs/containerlab) ⭐ 2,778 | 🐛 51 | 🌐 Go | 📅 2026-08-26 - Container-based networking labs, though support has been added to integrate Virtual Machines (VMs).
* [netlab](https://github.com/ipspace/netlab) ⭐ 731 | 🐛 26 | 🌐 Python | 📅 2026-08-27 - netlab is bringing infrastructure-as-code concepts to networking labs. You'll describe your high-level network topology and routing design in a YAML file, and the tools in this repository auto-define details.
* [CML](https://www.cisco.com/site/us/en/learn/training-certifications/training/modeling-labs/index.html) - Cisco Modeling Labs is a network simulation tool with both free and paid versions. CML is the successor to VIRL. Community contributed content and resources are available via [cml-community](https://github.com/CiscoDevNet/cml-community) ⭐ 638 | 🐛 5 | 🌐 Shell | 📅 2026-08-06.
...
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 10,959 | 🐛 43 | 🌐 Shell | 📅 2026-07-01 - a Docker + Kubernetes network trouble-shooting swiss-army container.
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 10,959 | 🐛 43 | 🌐 Shell | 📅 2026-07-01 - a Docker + Kubernetes network trouble-shooting swiss-army container.
...
* [netdata](https://github.com/firehol/netdata) ⭐ 80,320 | 🐛 387 | 🌐 Go | 📅 2026-08-27 - Distributed real-time performance and health monitoring.
...
* ELK Stack
  * [Elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,869 | 🐛 5,950 | 🌐 Java | 📅 2026-08-27 - Open Source, Distributed, RESTful Search Engine.
  * [Kibana](https://github.com/elastic/kibana) ⭐ 21,265 | 🐛 14,253 | 🌐 TypeScript | 📅 2026-08-27 - Analytics and search dashboard for Elasticsearch.
  * [LogStash](https://github.com/elastic/logstash) ⭐ 14,927 | 🐛 2,250 | 🌐 Java | 📅 2026-08-26 - Transport and process your logs, events, or other data.
