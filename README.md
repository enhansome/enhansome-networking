...
An [awesome list](https://github.com/sindresorhus/awesome) ⭐ 510,583 | 🐛 107 | 📅 2026-09-02 of resources to design, implement and operate computer networks.
...
* [Pilot Protocol](https://github.com/TeoSlayer/pilotprotocol) ⭐ 140 | 🐛 11 | 🌐 Go | 📅 2026-09-25 - Overlay network stack for AI agents with virtual addresses, encrypted UDP tunnels (AES-256-GCM), NAT traversal, and mutual trust. Written in Go with zero dependencies.
...
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,491 | 🐛 39 | 🌐 C | 📅 2026-09-25 - Arkime augments your current security infrastructure to store and index network traffic in standard PCAP format, providing fast, indexed access.
* [snabb](https://github.com/snabbco/snabb) ⭐ 3,032 | 🐛 16 | 🌐 Lua | 📅 2026-07-30 - Snabb (formerly "Snabb Switch") is a simple and fast packet networking toolkit.
...
* [Oxidized](https://github.com/ytti/oxidized) ⭐ 3,591 | 🐛 64 | 🌐 Ruby | 📅 2026-09-23 - Network device configuration backup tool. It's a [RANCID](https://www.shrubbery.net/rancid/) replacement.
* [Batfish](https://github.com/batfish/batfish) ⭐ 1,486 | 🐛 286 | 🌐 Java | 📅 2026-09-26 - Network configuration analysis tool that can find bugs and guarantee the correctness of (planned or current) network configurations.
...
* [fetchconfig](https://github.com/udhos/fetchconfig) ⭐ 15 | 🐛 2 | 🌐 Perl | 📅 2026-09-25 - fetchconfig is a Perl script for retrieving configuration of
  multiple devices.
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,788 | 🐛 852 | 🌐 Python | 📅 2026-09-24 - IT automation platform that makes your applications and systems easier to deploy by using SSH, with no agents to install on remote systems.
* [AWX](https://github.com/ansible/awx) ⭐ 15,573 | 🐛 1,872 | 🌐 Python | 📅 2026-09-25 - the upstream project for Tower / AAP2, a commercial derivative of AWX.
* [netmiko](https://github.com/ktbyers/netmiko) ⭐ 4,295 | 🐛 64 | 🌐 Python | 📅 2026-09-21 - Multi-vendor library to simplify Paramiko SSH connections to network devices.
* [nornir](https://github.com/nornir-automation/nornir) ⭐ 1,627 | 🐛 46 | 🌐 Python | 📅 2026-09-23 - Pluggable multi-threaded framework with inventory management to help operate collections of devices.
* [ntc-templates](https://github.com/networktocode/ntc-templates) ⭐ 1,296 | 🐛 44 | 🌐 Python | 📅 2026-09-16 - TextFSM templates for parsing show commands of network devices.
...
* [CNaaS-NMS](https://github.com/SUNET/cnaas-nms) ⭐ 93 | 🐛 32 | 🌐 Python | 📅 2026-09-25 - Campus Network-as-a-Service - Network Management System. Software to automate management of a campus network (LAN).
...
* [DefenseClaw](https://github.com/cisco-ai-defense/defenseclaw) ⭐ 851 | 🐛 28 | 🌐 Go | 📅 2026-09-26 - DefenseClaw is the enterprise governance layer for OpenClaw
* [NetClaw](https://github.com/automateyournetwork/netclaw) ⭐ 668 | 🐛 1 | 🌐 Python | 📅 2026-09-20 - A CCIE-level AI network engineering coworker, built on OpenClaw
...
* [netbox](https://github.com/digitalocean/netbox) ⭐ 21,603 | 🐛 224 | 🌐 Python | 📅 2026-09-26 - IP address management (IPAM) and data center infrastructure management (DCIM) tool.
* [nautobot](https://github.com/nautobot/nautobot) ⭐ 1,612 | 🐛 1,028 | 🌐 Python | 📅 2026-09-25 - Network Source of Truth & Network Automation Platform.
* [drawthe.net](https://github.com/cidrblock/drawthe.net) ⭐ 1,181 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-25 - Draws network diagrams dynamically from a text file describing the placement, layout and icons.
* [infrahub](https://github.com/opsmill/infrahub) ⭐ 526 | 🐛 570 | 🌐 Python | 📅 2026-09-25 -  Infrahub is a graph-based data management platform with built-in version control, CI workflows, peer review, and API access. It’s purpose-built to power reliable infrastructure automation at scale.
...
* [containerlab](https://github.com/srl-labs/containerlab) ⭐ 2,838 | 🐛 69 | 🌐 Go | 📅 2026-09-22 - Container-based networking labs, though support has been added to integrate Virtual Machines (VMs).
* [netlab](https://github.com/ipspace/netlab) ⭐ 746 | 🐛 27 | 🌐 Python | 📅 2026-09-26 - netlab is bringing infrastructure-as-code concepts to networking labs. You'll describe your high-level network topology and routing design in a YAML file, and the tools in this repository auto-define details.
...
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 11,015 | 🐛 44 | 🌐 Shell | 📅 2026-09-22 - a Docker + Kubernetes network trouble-shooting swiss-army container.
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 11,015 | 🐛 44 | 🌐 Shell | 📅 2026-09-22 - a Docker + Kubernetes network trouble-shooting swiss-army container.
...
* [netdata](https://github.com/firehol/netdata) ⭐ 80,656 | 🐛 411 | 🌐 Go | 📅 2026-09-26 - Distributed real-time performance and health monitoring.
...
* ELK Stack
  * [Elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,993 | 🐛 6,084 | 🌐 Java | 📅 2026-09-26 - Open Source, Distributed, RESTful Search Engine.
  * [Kibana](https://github.com/elastic/kibana) ⭐ 21,302 | 🐛 14,539 | 🌐 TypeScript | 📅 2026-09-26 - Analytics and search dashboard for Elasticsearch.
  * [LogStash](https://github.com/elastic/logstash) ⭐ 14,951 | 🐛 2,254 | 🌐 Java | 📅 2026-09-25 - Transport and process your logs, events, or other data.
