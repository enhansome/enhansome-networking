...
An [awesome list](https://github.com/sindresorhus/awesome) ⭐ 508,734 | 🐛 106 | 📅 2026-09-02 of resources to design, implement and operate computer networks.
...
* [Firezone](https://github.com/firezone/firezone) ⭐ 9,103 | 🐛 397 | 🌐 Elixir | 📅 2026-09-22 - Open-source VPN server and egress firewall for Linux built on WireGuard. Firezone is easy to set up (all dependencies are bundled thanks to Chef Omnibus), secure, performant, and self hostable.
...
* [Arkime](https://github.com/arkime/arkime) ⭐ 7,472 | 🐛 38 | 🌐 C | 📅 2026-09-18 - Arkime augments your current security infrastructure to store and index network traffic in standard PCAP format, providing fast, indexed access.
* [snabb](https://github.com/snabbco/snabb) ⭐ 3,032 | 🐛 15 | 🌐 Lua | 📅 2026-07-30 - Snabb (formerly "Snabb Switch") is a simple and fast packet networking toolkit.
...
* [Oxidized](https://github.com/ytti/oxidized) ⭐ 3,588 | 🐛 64 | 🌐 Ruby | 📅 2026-09-22 - Network device configuration backup tool. It's a [RANCID](https://www.shrubbery.net/rancid/) replacement.
* [Batfish](https://github.com/batfish/batfish) ⭐ 1,481 | 🐛 281 | 🌐 Java | 📅 2026-09-21 - Network configuration analysis tool that can find bugs and guarantee the correctness of (planned or current) network configurations.
...
* [Ansible](https://github.com/ansible/ansible) ⭐ 70,759 | 🐛 836 | 🌐 Python | 📅 2026-09-21 - IT automation platform that makes your applications and systems easier to deploy by using SSH, with no agents to install on remote systems.
* [AWX](https://github.com/ansible/awx) ⭐ 15,568 | 🐛 1,873 | 🌐 Python | 📅 2026-09-22 - the upstream project for Tower / AAP2, a commercial derivative of AWX.
* [netmiko](https://github.com/ktbyers/netmiko) ⭐ 4,291 | 🐛 62 | 🌐 Python | 📅 2026-09-21 - Multi-vendor library to simplify Paramiko SSH connections to network devices.
...
* [CNaaS-NMS](https://github.com/SUNET/cnaas-nms) ⭐ 93 | 🐛 31 | 🌐 Python | 📅 2026-09-16 - Campus Network-as-a-Service - Network Management System. Software to automate management of a campus network (LAN).
...
* [DefenseClaw](https://github.com/cisco-ai-defense/defenseclaw) ⭐ 848 | 🐛 25 | 🌐 Go | 📅 2026-09-22 - DefenseClaw is the enterprise governance layer for OpenClaw
...
* [BGPAlerter](https://github.com/nttgin/BGPalerter) ⭐ 1,016 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-17 - Self-configuring BGP monitoring tool
...
* [Malcolm](https://github.com/idaholab/Malcolm) ⭐ 482 | 🐛 2 | 🌐 Python | 📅 2026-08-25 - Malcolm is a powerful, easily deployable network traffic analysis tool suite for full packet capture artifacts (PCAP files) and Zeek logs.
...
* [netbox](https://github.com/digitalocean/netbox) ⭐ 21,580 | 🐛 223 | 🌐 Python | 📅 2026-09-22 - IP address management (IPAM) and data center infrastructure management (DCIM) tool.
* [nautobot](https://github.com/nautobot/nautobot) ⭐ 1,612 | 🐛 1,026 | 🌐 Python | 📅 2026-09-22 - Network Source of Truth & Network Automation Platform.
...
* [infrahub](https://github.com/opsmill/infrahub) ⭐ 524 | 🐛 564 | 🌐 Python | 📅 2026-09-21 -  Infrahub is a graph-based data management platform with built-in version control, CI workflows, peer review, and API access. It’s purpose-built to power reliable infrastructure automation at scale.
...
* [containerlab](https://github.com/srl-labs/containerlab) ⭐ 2,827 | 🐛 68 | 🌐 Go | 📅 2026-09-22 - Container-based networking labs, though support has been added to integrate Virtual Machines (VMs).
* [netlab](https://github.com/ipspace/netlab) ⭐ 742 | 🐛 24 | 🌐 Python | 📅 2026-09-21 - netlab is bringing infrastructure-as-code concepts to networking labs. You'll describe your high-level network topology and routing design in a YAML file, and the tools in this repository auto-define details.
...
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 11,006 | 🐛 43 | 🌐 Shell | 📅 2026-07-01 - a Docker + Kubernetes network trouble-shooting swiss-army container.
* [netshoot](https://github.com/nicolaka/netshoot) ⭐ 11,006 | 🐛 43 | 🌐 Shell | 📅 2026-07-01 - a Docker + Kubernetes network trouble-shooting swiss-army container.
...
* [netdata](https://github.com/firehol/netdata) ⭐ 80,616 | 🐛 406 | 🌐 Go | 📅 2026-09-22 - Distributed real-time performance and health monitoring.
...
* ELK Stack
  * [Elasticsearch](https://github.com/elastic/elasticsearch) ⭐ 77,958 | 🐛 6,066 | 🌐 Java | 📅 2026-09-22 - Open Source, Distributed, RESTful Search Engine.
  * [Kibana](https://github.com/elastic/kibana) ⭐ 21,295 | 🐛 14,655 | 🌐 TypeScript | 📅 2026-09-22 - Analytics and search dashboard for Elasticsearch.
  * [LogStash](https://github.com/elastic/logstash) ⭐ 14,946 | 🐛 2,256 | 🌐 Java | 📅 2026-09-21 - Transport and process your logs, events, or other data.
